...
import {
  StoriesContainer, StoriesBGImageContainer, StoriesButtonContainer,
  StoriesTitleContainer, StoryContentContainer, StoryShapeContainer,
  StoryTextContainer, StoryContainer
  ...
  return (
    <StoriesContainer>
      <StoriesBGImageContainer>
        <img src={data.nature5.publicURL} alt='nature 5' />
      </StoriesBGImageContainer>
...
const query = graphql`
  {
    nature5: file(relativePath: {eq: "nature-5.jpg"}) {
      publicURL
    }
