...
import {
  CardContainer, CardHeaderContainer, CardPictureContainer,
  CardPictureOverlay, CardPictureImage, CardDetailsContainer,
  CardSubHeading, CardText, CardDataContainer, CardFooterContainer,
  CardFooterValue, CardFooterText, CardRatings
    ...
    <CardContainer>
      <CardHeaderContainer>
        <CardPictureContainer>
          ...
          <CardPictureImage
            src={optimizeCloudinaryImage(tour.imageCover, 'h_250,q_50')}
            alt={tour.name}
          />
        </CardPictureContainer>
