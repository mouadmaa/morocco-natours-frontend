...
export const CardFooterValue = styled.span`font-weight: 600;`

export const CardFooterText = styled.span`color: ${({ theme }) => theme.color.grayDark1};`

export const CardRatings = styled.p`grid-row: 2 / 3;`
